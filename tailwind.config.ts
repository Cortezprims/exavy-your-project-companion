  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "task-complete": "task-complete 0.5s cubic-bezier(0.4, 0, 0.2, 1)",
        "bounce-subtle": "bounce-subtle 0.6s cubic-bezier(0.4, 0, 0.2, 1)",
      },
    },
  },
